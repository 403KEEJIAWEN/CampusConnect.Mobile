...
namespace CampusConnect.Mobile.Views
{
    public class PostPage : ContentPage
    {
        ...
        public PostPage(string userEmail)
        {
            ...
            {
                MainThread.BeginInvokeOnMainThread(async () => { await LoadFeed(); });
            });
        }
        ...
        async Task LoadFeed()
        {
            try
            {
                ...
                var result = await apiService.GetFeedAsync(userEmail);
                posts.Clear();
